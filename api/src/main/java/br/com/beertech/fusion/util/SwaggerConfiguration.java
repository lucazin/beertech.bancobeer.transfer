...
public class SwaggerConfiguration {
    ...
    private ApiInfo apiInfo() {
        ...
        apiInfoBuilder.description("Individual Legacy POC - Controle Bancário");
        apiInfoBuilder.version("V1.0.0");
        apiInfoBuilder.contact(new Contact("Lucas Bergamo", "https://www.linkedin.com/in/lucasbergamo/",
                "bergamo86@gmail.com"));
